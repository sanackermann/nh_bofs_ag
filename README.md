...
| **sc_config**       | Konfiguriert einen **bestehenden Windows-Service** (BinPath, ErrorMode, StartMode) lokal oder remote.                                                    | `sc_config <SVCNAME> <BINPATH> <ERRORMODE> <STARTMODE> [HOSTNAME]`                                    |
| **sc_create**       | Erstellt einen **neuen Windows-Service** auf dem Zielhost (inkl. Displayname/Description), optional remote + Service-Typ.                                | `sc_create <SVCNAME> <DISPLAYNAME> <BINPATH> <DESCRIPTION> <ERRORMODE> <STARTMODE> [TYPE] [HOSTNAME]` |
| **sc_delete**       | Löscht einen Windows-Service lokal oder auf einem angegebenen Host.                                                                                      | `sc_delete <SVCNAME> [HOSTNAME]`                                                                      |
| **sc_stop**         | Stoppt einen Windows-Service lokal oder remote.                                                                                                          | `sc_stop <SVCNAME> [HOSTNAME]`                                                                        |
| **sc_start**        | Startet einen Windows-Service lokal oder remote.                                                                                                         | `sc_start <SVCNAME> [HOSTNAME]`                                                                       |
| **enableuser**      | Aktiviert/entsperrt einen Benutzeraccount (Domain- oder lokaler Account, je nach DOMAIN-Parameter).                                                      | `enableuser <USERNAME> [DOMAIN]`                                                                      |
| **persist_service** | Erstellt **Persistenz als Windows-Service**: lädt optional eine Service-Binary hoch, erstellt Service `agcssvc`, setzt Failure-Recovery und startet ihn. | `persist_service <SERVICE_BINARY_ON_ATTACKER_COMPUTER>`                                               |
